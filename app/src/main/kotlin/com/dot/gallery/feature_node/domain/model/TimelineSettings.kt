...
data class TimelineSettings(
    ...
    @ColumnInfo(defaultValue = "{\"orderType\":{\"type\":\"com.ajstudioz.gallery.feature_node.domain.util.OrderType.Descending\"},\"orderType_date\":{\"type\":\"com.ajstudioz.gallery.feature_node.domain.util.OrderType.Descending\"}}")
